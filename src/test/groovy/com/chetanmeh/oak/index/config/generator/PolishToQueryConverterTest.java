...
public class PolishToQueryConverterTest {
  ...
  public void testXPath() {
    ...
    checkConvert("function*coalesce*@jcr:content/foo2*coalesce*@jcr:content/foo*lower*@:name",
      "fn:coalesce(jcr:content/@foo2,fn:coalesce(jcr:content/@foo,fn:lower-case(fn:name())))",true);
    checkConvert("function*coalesce*coalesce*@jcr:content/foo2*@jcr:content/foo*coalesce*@a:b*@c:d",
      "fn:coalesce(fn:coalesce(jcr:content/@foo2,jcr:content/@foo),fn:coalesce(@a:b,@c:d))",true);
  ...
  public void testSql2() {
    ...
    checkConvert("function*coalesce*coalesce*@jcr:content/foo2*@jcr:content/foo*coalesce*@a:b*@c:d",
      "coalesce(coalesce([jcr:content/foo2],[jcr:content/foo]),coalesce([a:b],[c:d]))",false);
    checkConvert("function*first*@jcr:content/foo2",
